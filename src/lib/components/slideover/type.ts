import type { WithoutChild, DialogRootProps, DialogContentProps, DialogTriggerProps } from 'bits-ui'
...
export interface SlideoverProps extends DialogRootProps, DialogTriggerProps, SlideoverSlots {
	title?: string
	description?: string
	overlay?: boolean
	transition?: boolean
	...
	triggerProps?: WithoutChild<DialogTriggerProps>
